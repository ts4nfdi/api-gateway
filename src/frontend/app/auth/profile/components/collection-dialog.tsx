...
export default function CollectionDialog({
    ...
    return <DialogWrapper title={collection.id ? "Edit Collection" : "Create a New Collection"} isOpen={isOpen}
                          setIsOpen={setIsOpen} onSubmit={handleSave}>
        <div className="space-y-6  overflow-y-auto px-1">
            <div className="space-y-3">
                ...
                <div>
                    ...
                    <DatabaseSelector selected={selectedSources}
                                      onChange={(sources: string[]) => setSelectedSources(sources)}/>
                </div>
