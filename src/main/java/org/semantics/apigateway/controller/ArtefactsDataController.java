...
public class ArtefactsDataController {
    ...
    @GetMapping(value = {"/terms", "/resources/classes", "/resources/concepts"})
    ...
    @GetMapping(value = {"/terms/{uri}", "/resources/classes/{uri}", "/resources/concepts/{uri}"})
    @Operation(summary = "Get a list of all owl:Classes or skos:Concepts within an artefact.")
    ...
    @GetMapping(value = {"/schemes", "/resources/schemes"})
    ...
    @GetMapping(value = {"/schemes/{uri}", "/resources/schemes/{uri}"})
    ...
    @GetMapping(value = {"/collections", "/resources/collections"})
    ...
    @GetMapping(value = {"/collections/{uri}", "/resources/collections/{uri}"})
